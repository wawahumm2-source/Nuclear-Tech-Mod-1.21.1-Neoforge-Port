...
| Fuel state was not readable from the GUI. | fixed, pending screenshot | Fuel hover text now reports stored operations left, matching the original GUI information pattern. |
