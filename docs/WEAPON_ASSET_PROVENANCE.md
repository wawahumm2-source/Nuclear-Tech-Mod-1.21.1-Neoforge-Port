...
Superb Warfare is a behavior and engineering reference only. No Superb Warfare model, texture, animation, or sound is selected or inventoried here.
...
| StG 77 | `src/main/resources/assets/hbm/models/item/gun_stg77.json` | `aa13d3233b92ba10155f3cd2fcea30ef65f65f30daae01e31b44c7f786a9068f` | Modern `builtin/entity` model with first-person, third-person, GUI, ground, and fixed transforms. |
...
| SPAS-12 | `src/main/resources/assets/hbm/models/item/gun_spas12.json` | `aa13d3233b92ba10155f3cd2fcea30ef65f65f30daae01e31b44c7f786a9068f` | Modern `builtin/entity` model with first-person, third-person, GUI, ground, and fixed transforms. |
